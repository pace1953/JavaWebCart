					...
					<div class="products-container">
						<c:forEach var="productDTO" items="${ productDTOs }">
							<div class="product-item" onmouseover="this.style.backgroundColor='#E0E0ff'" 
								...
								<a class="pure-button pure-button-primary" href="/JavaWebCart/product/order/add/cart?productId=${ productDTO.productId }" onclick="return confirm('確定要選購此商品嗎？')" class="delete-btn">加入購物車</a>
							</div>
						</c:forEach>	
					</div>
				</table>
