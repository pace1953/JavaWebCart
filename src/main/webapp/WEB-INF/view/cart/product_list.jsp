				...
				<td valign="top">
					<fieldset>
						...
						<form enctype="multipart/form-data" method="post" action="/JavaWebCart/product/add">
							...
							<button type="submit" onclick="return confirm('確定要新增此商品嗎？')" class="delete-btn">新增商品</button>
						</form>
					</fieldset>	
				</td>
				<td valign="top">
							...
							<tbody>
								...
								<c:forEach var="productDTO" items="${ productDTOs }">
									<tr onmouseover="this.style.backgroundColor='#E0E0ff'" 
										...
										<td>
											<a href="/JavaWebCart/product/delete?productId=${ productDTO.productId }"onclick="return confirm('確定要刪除此商品嗎？')" class="delete-btn">刪除</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
