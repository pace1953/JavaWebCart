...
public class EmailService {
	...
	public static void main(String[] args) {
		new EmailService().sendEmail("61108013E@gapps.ntnu.edu.tw", "http://localhost:8080/JavaWebCart/");
	}
	// Google應用程式密碼
	// 請參考此篇 https://www.yongxin-design.com/Article/10
	// 請自行產生Google應用程式密碼
	String googleAppPassword = "qpkh akaj aqhp sipo";

	// 寄件者的電子郵件地址
	String from = "enjoy23519105@gmail.com";
